...
import { 
  History, Target, Ship, MapPin, 
  Phone, Mail, Info, Award, Users, 
  ShieldCheck, Star, Briefcase, 
  Droplets, Wind, CheckCircle2, ChevronRight
} from "lucide-react";
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-4 md:p-8 space-y-8 pb-24">
        ...
        <header className="bg-white/60 backdrop-blur-md p-8 rounded-[2.5rem] border border-white shadow-sm text-center space-y-4">
          ...
          <p className="text-slate-600 font-medium max-w-xl mx-auto leading-relaxed">
            Established in 2003, we have established ourselves as a prominent player in the UAE with high-quality service delivery exceeding customer expectations.
          </p>
        </header>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-white shadow-sm text-center space-y-1">
        ...
        <section className="space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-white/90 backdrop-blur-xl p-6 rounded-[2rem] border border-white shadow-sm space-y-3">
                ...
                <h4 className="font-black text-slate-900 uppercase text-xs tracking-widest">{process.title}</h4>
        ...
        <section className="bg-white/60 backdrop-blur-md p-8 rounded-[2.5rem] border border-white shadow-sm space-y-6">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
            ...
            <h3 className="text-lg font-black text-slate-900 tracking-tight">Our Major Clients</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
            {[
              "Armed Forces Officers Club", "Pan Emirates Home Furnishing", 
              "Multi Tech Engineering", "Al Rostomani Heavy Vehicle", 
              "Galadari Heavy Equipment", "Sharjah International Airport Hotel", 
              "City Taxi", "Mangurad Security", "Malabar Gold", 
              "Brightwell Product LLC", "DAMAC (Green Point)", "Gb Equipments",
              "Certis Guarding LLC", "Farnek Services LLC", "Al Bawardy Marine Engineering"
            ].map((client, i) => (
              <div key={i} className="flex items-center gap-3 text-slate-600 hover:text-brand-primary transition-colors cursor-default">
      ...
      Machinery Image
        ...
        <section className="bg-slate-900 p-8 rounded-[2.5rem] shadow-xl text-white space-y-8">
          <div className="flex items-center gap-3 border-b border-white/10 pb-4">
            ...
            <div>
              <h2 className="font-black text-lg tracking-tight">Official Contact</h2>
              <p className="text-[10px] font-black uppercase tracking-widest text-brand-primary">Al Nejoum Al Arbaah Laundry</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-sm font-medium">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <MapPin className="shrink-0 mt-1 text-brand-primary" size={20} />
                <p className="leading-relaxed text-slate-300">
                  Industrial Area-13, Behind National Paint<br />
                  Near to Dubai Dates Factory<br />
                  Post Box No. 26697, Sharjah
                </p>
              </div>
              <div className="flex items-center gap-4">
                <Mail className="shrink-0 text-brand-primary" size={20} />
                <a href="mailto:alnejoumlaundry@yahoo.com" className="text-slate-300 hover:text-white transition-colors underline underline-offset-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase text-slate-500 tracking-widest">Office Tel & Fax</p>
                    <p className="text-slate-200">06-5530600</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase text-slate-500 tracking-widest">Mobile / WhatsApp</p>
